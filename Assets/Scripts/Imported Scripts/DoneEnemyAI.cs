...
public class DoneEnemyAI : MonoBehaviour
{
	...
	private VRPlayerHealth playerHealth;					// Reference to the PlayerHealth script.
	private InfiltrationManager infiltrationManager;		// Reference to the last global sighting of the player.
